...
#define LOW_PRECISION`),t}function zm(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===oc?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===gh?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Ti&&(t="SHADOWMAP_TYPE_VSM"),t}function Hm(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case qn:case Yn:t="ENVMAP_TYPE_CUBE";break;case br:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Vm(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Yn:t="ENVMAP_MODE_REFRACTION";break}return t}function Gm(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case ac:t="ENVMAP_BLENDING_MULTIPLY";break;case Uh:t="ENVMAP_BLENDING_MIX";break;case Fh:t="ENVMAP_BLENDING_ADD";break}return t}function Wm(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:i,maxMip:e}}function Xm(s,t,e,i){const n=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=zm(e),c=Hm(e),h=Vm(e),u=Gm(e),d=Wm(e),f=Im(e),g=Dm(r),_=n.createProgram();let m,p,w=e.glslVersion?"#version "+e.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}mn.BlurDirectionX=new ct(1,0);mn.BlurDirectionY=new ct(0,1);const Q0={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
