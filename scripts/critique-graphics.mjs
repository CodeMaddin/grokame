...
if (!html.includes('pause-btn')) fail('no pause/menu control during play');
if (!html.includes('hud-arsenal') || !html.includes('hud-vitals')) fail('arsenal/hull/boost are not cornered');
if (!html.includes('id="view-switcher"')) fail('no view switcher');
