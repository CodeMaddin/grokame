...
ok(crafts.includes('createCinderHunter') && crafts.includes('createSlagHunter'), 'crimson unique hunters exist');
ok(crafts.includes('createAcolyteHunter') && crafts.includes('createChimeHunter'), 'cathedral unique hunters exist');
ok(crafts.includes('createBloomHunter') && crafts.includes('createPrismHunter'), 'iris unique hunters exist');
ok(crafts.includes('createIonHunter') && crafts.includes('createWispHunter'), 'heart unique hunters exist');
ok(crafts.includes('createCoilTyrant') && crafts.includes('createEmpressCraft'), 'coil and empress have unique crafts');
ok(entities.includes('createCinderHunter') && entities.includes('createCoilTyrant'), 'unique hunters are spawned');
...
ok(html.includes('pause-btn'), 'pause/menu control exists');
ok(html.includes('hud-arsenal') && html.includes('hud-vitals'), 'arsenal and vitals are cornered');
ok(html.includes('hud-stock'), 'lives and bombs sit in top stock');
ok(css.includes('#view-switcher'), 'view chips exist');
ok(!css.includes('#hud.visible #view-switcher {\n  display: none'), 'view chips stay available');
